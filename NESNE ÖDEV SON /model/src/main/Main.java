...
public class Main {
    ...
    // isEqual metodu, iki nesnenin .equals() metodunu kullanarak eşit olup olmadığını kontrol eder,


   // LambdaFunctionInterface, yalnızca bir soyut metod içeren ve lambda ifadeleri ile
   // kullanılmak üzere tasarlanmış bir fonksiyonel arayüzü temsil eder.
    ...
    public static void main(String[] args) {
        ...
        // This code simulates a login page prompting the user to enter a username and password
        // Lambda expressions are used in this scenario to handle specific situations.
